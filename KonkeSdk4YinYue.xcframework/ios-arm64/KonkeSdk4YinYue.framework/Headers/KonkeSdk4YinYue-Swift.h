...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) KonkeCloudConfig * _Nonnull cloudConfig;)
+ (KonkeCloudConfig * _Nonnull)cloudConfig SWIFT_WARN_UNUSED_RESULT;
